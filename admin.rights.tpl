...
<!-- END: RIGHTS_ROW_ITEMS -->
										<td class="text-center">
											<div class="btn-group nomargin">
												<a class="btn btn-default btn-{PHP.R.admin-config-buttonsize2}" title="{PHP.L.Rights}" href="{ADMIN_RIGHTS_ROW_RIGHTSBYITEM}"><i class="fa fa-lock"></i> {PHP.L.Rights}</a>
												<a class="btn btn-default btn-{PHP.R.admin-config-buttonsize2}" title="{PHP.L.Rights}" href="{ADMIN_RIGHTS_ROW_LINK}"><i class="fa fa-folder-open"></i> {PHP.L.Open}</a>
											</div>
										</td>
