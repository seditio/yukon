				...
				<div class="block">
					...
					<div class="wrapper">
						<div class="btn-group item-control">
							...
							<a class="btn btn-{PHP.R.admin-config-buttonsize1} <!-- IF {ADMIN_EXTENSIONS_ONLY_INSTALLED_SEL} -->btn-success special" href="{ADMIN_EXTENSIONS_ONLY_INSTALLED_URL}"<!-- ELSE -->btn-primary" href="{ADMIN_EXTENSIONS_ONLY_INSTALLED_URL}"<!-- ENDIF -->><i class="fa fa-check-square-o"></i> <span>{PHP.L.adm_only_installed}</span></a>
