						...
						<tbody>
							...
							<tr class="{PHP.R.admin-table-tr-class}">
								...
								<td>
									...
									<span class="text-success">{ADMIN_EXTENSIONS_VERSION_INSTALLED}</span> / <span class="text-danger-emphasis">{ADMIN_EXTENSIONS_VERSION}</span>
									<!-- ELSE -->
								...
								<td class="action">
									<div class="btn-group">
										...
										<a title="{PHP.L.Configuration}" href="{ADMIN_EXTENSIONS_EDIT_URL}" class="btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
											{PHP.R.icon-gear}<span>{PHP.L.Config}</span>
										</a>
										<!-- ENDIF -->
										<!-- IF {ADMIN_EXTENSIONS_STRUCTURE_URL} -->
										<a title="{PHP.L.Structure}" href="{ADMIN_EXTENSIONS_STRUCTURE_URL}" class="btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
											{PHP.R.icon-sitemap}<span>{PHP.L.Structure}</span>
										</a>
										<!-- ENDIF -->
										<!-- IF {ADMIN_EXTENSIONS_RIGHTS_URL} -->
										<a title="{PHP.L.Rights}" href="{ADMIN_EXTENSIONS_RIGHTS_URL}" class="btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
											{PHP.R.icon-lock}<span>{PHP.L.Rights}</span>
										</a>
										<!-- ENDIF -->
										<!-- IF {ADMIN_EXTENSIONS_ADMIN_URL} -->
										<a title="{PHP.L.Administration}" href="{ADMIN_EXTENSIONS_ADMIN_URL}" class="btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
											{PHP.R.icon-user}<span>{PHP.L.Admin}</span>
										</a>
										<!-- ENDIF -->
										<!-- IF {ADMIN_EXTENSIONS_JUMPTO_URL} -->
										<a title="{PHP.L.Open}" href="{ADMIN_EXTENSIONS_JUMPTO_URL}" class="btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
											{PHP.R.icon-folder-open}<span>{PHP.L.Open}</span>
										</a>
										<!-- ENDIF -->
									</div>
								</td>
			...
			<div class="wrapper">
				<div class="{PHP.R.admin-table-responsive-container-class}">
					...
					<div class="btn-group mb-{PHP.R.admin-button-group-margin}">
						<!-- IF {ADMIN_EXTENSIONS_JUMPTO_URL} -->
						<a title="{PHP.L.Open}" href="{ADMIN_EXTENSIONS_JUMPTO_URL}" class="btn {PHP.R.admin-button-primary-class} {PHP.R.admin-top-button-size-class}">
							{PHP.R.icon-folder-open}{PHP.L.Open}
						</a>
						<!-- ENDIF -->
						<!-- IF {ADMIN_EXTENSIONS_ADMIN_URL} -->
						<a title="{PHP.L.Administration}" href="{ADMIN_EXTENSIONS_ADMIN_URL}" class="btn {PHP.R.admin-button-primary-class} {PHP.R.admin-top-button-size-class}">
							{PHP.R.icon-user}{PHP.L.Administration}
						</a>
						<!-- ENDIF -->
						<!-- IF {ADMIN_EXTENSIONS_TOTALCONFIG} > 0 -->
						<a title="{PHP.L.Configuration}" href="{ADMIN_EXTENSIONS_CONFIG_URL}" class="btn {PHP.R.admin-button-primary-class} {PHP.R.admin-top-button-size-class}">
							{PHP.R.icon-gear}{PHP.L.Configuration} ({ADMIN_EXTENSIONS_TOTALCONFIG})
						</a>
						<!-- ENDIF -->
						<!-- IF {ADMIN_EXTENSIONS_RIGHTS_URL} -->
						<a title="{PHP.L.Rights}" href="{ADMIN_EXTENSIONS_RIGHTS_URL}" class="btn {PHP.R.admin-button-danger-class} {PHP.R.admin-top-button-size-class}">
							{PHP.R.icon-lock}{PHP.L.Rights}
						</a>
						<!-- ENDIF -->
						<!-- IF {ADMIN_EXTENSIONS_STRUCTURE_URL} -->
						<a title="{PHP.L.Structure}" href="{ADMIN_EXTENSIONS_STRUCTURE_URL}" class="btn {PHP.R.admin-button-primary-class} {PHP.R.admin-top-button-size-class}">
							{PHP.R.icon-sitemap}{PHP.L.Structure}
						</a>
						<!-- ENDIF -->
					</div>
					<!-- ENDIF -->
...
<td>{ADMIN_EXTENSIONS_ADMRIGHTS_LOCK_MEMBERS} ({ADMIN_EXTENSIONS_LOCK_MEMBERS})</td>
						...
						<tr>
							<td class="text-end">
								{ADMIN_EXTENSIONS_DEPENDENCIES_TITLE}:
							</td>
							<td>
						...
						<tr>
							...
							<td class="action">
								<div class="btn-group">
									...
									<a title="{PHP.L.adm_opt_install_explain}" href="{ADMIN_EXTENSIONS_INSTALL_URL}" class="ajax btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
										{PHP.R.icon-plus}<span>{PHP.L.adm_opt_install}</span>
									</a>
									<!-- ENDIF -->
									<!-- IF {PHP.isInstalled} -->
									<!-- IF {PHP.exists} -->
									<a title="{PHP.L.adm_opt_install_explain}" href="{ADMIN_EXTENSIONS_UPDATE_URL}" class="ajax btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
										{PHP.R.icon-refresh}<span>{PHP.L.adm_opt_update}</span>
									</a>
									<!-- ENDIF -->
									<a title="{PHP.L.adm_opt_uninstall_explain}" href="{ADMIN_EXTENSIONS_UNINSTALL_URL}" class="ajax btn {PHP.R.admin-button-danger-class} {PHP.R.admin-button-size-class}">
										{PHP.R.icon-trash}<span>{PHP.L.adm_opt_uninstall}</span>
									</a>
									<a title="{PHP.L.adm_opt_pauseall_explain}" href="{ADMIN_EXTENSIONS_PAUSE_URL}" class="ajax btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
										{PHP.R.icon-pause}<span>{PHP.L.adm_opt_pauseall}</span>
									</a>
									<!-- IF {PHP.exists} -->
									<a title="{PHP.L.adm_opt_unpauseall_explain}" href="{ADMIN_EXTENSIONS_UNPAUSE_URL}" class="ajax btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
										{PHP.R.icon-play}<span>{PHP.L.adm_opt_unpauseall}</span>
									</a>
									<!-- ENDIF -->
									<!-- ENDIF -->
								</div>
					...
					<table class="{PHP.R.admin-table-class}">
						...
						<tr class="{PHP.R.admin-table-tr-class}">
							...
							<td>
								...
								<span class="text-danger">{ADMIN_EXTENSIONS_DETAILS_ROW_ORDER_INSTALLED}</span> / <span class="text-success">{ADMIN_EXTENSIONS_DETAILS_ROW_ORDER}</span>
								<!-- ELSE -->
							...
							<td class="action">
								...
								<div class="btn-group">
									...
									<a href="{ADMIN_EXTENSIONS_DETAILS_ROW_PAUSEPART_URL}" class="ajax btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
										{PHP.R.icon-pause}<span>{PHP.L.adm_opt_pause}</span>
									</a>
									<!-- END: ROW_PART_PAUSE -->
									<!-- BEGIN: ROW_PART_UNPAUSE -->
									<a href="{ADMIN_EXTENSIONS_DETAILS_ROW_UNPAUSEPART_URL}" class="ajax btn {PHP.R.admin-button-secondary-class} {PHP.R.admin-button-size-class}">
										{PHP.R.icon-play}<span>{PHP.L.adm_opt_unpause}</span>
									</a>
